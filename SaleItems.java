...
public class SaleItems {
     ...
     */
    public void addSale(String cityName, String itemName, double discount, boolean memberOnly, String limit)
            throws IOException {
        ...
        if (memberOnly) {
            System.out.println("Added sale: " + itemName + " with a discount of " + (discount * 100) + "% in "
                    + cityName + " that is members only");

        } else {
            System.out.println("Added sale: " + itemName + " with a discount of " + (discount * 100) + "% in "
                    + cityName + " that is for everyone");
        }
    }
